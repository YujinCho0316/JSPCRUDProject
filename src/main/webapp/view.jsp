...
<body>
    ...
    <table id="edit">
        ...
        <tr>
            <td>Img:</td><td>
            <c:if test="${u.getImg() ne ''}"><br><img src="${pageContext.request.contextPath }/upload/${vo.getImg()}" class="img>" </c:if><td/>
        </tr>
        <tr>
    ...
    <button type="button" oncilck="history.back()">뒤로가기</button>
